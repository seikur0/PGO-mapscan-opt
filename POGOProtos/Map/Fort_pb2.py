...
_FORTDATA.fields_by_name['active_fort_modifier'].enum_type = POGOProtos_dot_Inventory_dot_Item__pb2._ITEMID
...
_FORTMODIFIER.fields_by_name['item_id'].enum_type = POGOProtos_dot_Inventory_dot_Item__pb2._ITEMID
